import { catalogo } from "./utilidadades";
...
export function renderizarCatalago() {
  for (const produtoCatalogo of catalogo) {
    const cartaoProduto = `<div class='border-solid shadow-xl shadow-slate-400 rounded-lg w-48 m-2 flex flex-col p-2 justify-between group' id="card-produto-${produtoCatalogo.id}">
      <img src="assets/img/${produtoCatalogo.imagem}" alt="Produto 1 do Magazine Hashtag" class="group-hover:scale-110 duration-300 my-3 rounded-lg">
