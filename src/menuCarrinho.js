import { catalogo, salvarLocalStorage, lerLocalStorage } from "./utilidadades";
...
function desenharProdutoCarrinho(idProduto) {
  ...
  //<article class="flex bg-slate-100 rounded-lg p-1 relative">codigo do cartão do produto</article>
